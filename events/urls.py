...
urlpatterns = [
    ...
    path('convention/<int:pk>/calendar/<str:token>.ics', views.convention_ical_feed, name='convention_ical_feed_token'),
    ...
    path('convention/<int:pk>/admin/', views.admin_panel, name='admin_panel'),
    path('convention/<int:pk>/admin/<str:section>/', views.admin_panel, name='admin_panel_section'),
    ...
    path('ajax/convention/<int:convention_pk>/catalog/', views.get_convention_catalog_ajax, name='get_convention_catalog_ajax'),
